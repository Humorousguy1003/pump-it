...
const InvestedProjects = () => {
    ...
    return (
        <div className="xl:container container max-w-full mt-[60px] mb-[100px]">
            <h3 className="mb-[60px] text-center">Invested Projects</h3>
            <TopFilter />
            {data.length === 0 ? (
...
InvestedProjectsPage.getLayout = function getLayout(page: ReactElement) {
    return <Layout>{page}</Layout>;
};

export default InvestedProjectsPage;
